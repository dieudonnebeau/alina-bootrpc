package com.alina.bootrpc.generator.util;
...
import com.alina.bootrpc.generator.config.GenConfig;
...
public class VelocityUtils
{
     ...
     * @return 模板列表
     */
    public static VelocityContext prepareContext(SysGenTable genTable)
    {
    ...
    public static void setTreeVelocityContext(VelocityContext context, SysGenTable genTable)
    {
     ...
     * @return 返回需要导入的包列表
     */
    public static HashSet<String> getImportList(List<SysGenTableColumn> columns)
    {
     ...
     * @return 展开按钮列序号
     */
    public static int getExpandColumn(SysGenTable genTable)
    {
        String options = genTable.getOptions();
        JSONObject paramsObj = JSONObject.parseObject(options);
        String treeName = paramsObj.getString(GenConstants.TREE_NAME);
        int num = 0;
        for (SysGenTableColumn column : genTable.getColumns())
        {
            if (column.isList())
            {
                num++;
