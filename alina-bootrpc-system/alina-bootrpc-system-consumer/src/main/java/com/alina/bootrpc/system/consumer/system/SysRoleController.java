...
/**
 * @author     ：迪艾多
 * @date       ：Created on 2019/10/23 16:21
 * @description：角色信息
 * @modified By：
 * @version:     1.0
 */
...
public class SysRoleController extends BaseController
{
    ...
    public AjaxResult addSave(@Validated SysRole role)
    {
        ...
        return toAjax(roleService.saveNotNull(role));
    ...
    {
        mmap.put("role", roleService.queryByID(id));
        return prefix + "/edit";
    }
    ...
    public AjaxResult editSave(@Validated SysRole role)
    {
        ...
        ShiroUtils.clearCachedAuthorizationInfo();
        return toAjax(roleService.updateByIDNotNull(role));
    }
    ...
    {
        mmap.put("role", roleService.queryByID(roleId));
    ...
    public AjaxResult authDataScopeSave(SysRole role)
    {
        ...
        {
            ShiroUtils.setSysUser(userService.queryByID(ShiroUtils.getSysUser().getId()));
            return success();
        }
        return error();
    }
