...
/**
 * @author     ：迪艾多
 * @date       ：Created on 2019/10/14 16:36
 * @description：部门信息
 * @modified By：
 * @version:     1.0
 */
...
public class SysDeptController extends BaseController
{
    ...
    {
        List<SysDept> deptList = deptService.queryList(dept);
        return deptList;
    }
    ...
    {
        mmap.put("dept", deptService.queryByID(parentId));
        return prefix + "/add";
    }
    ...
    {
        SysDept dept = deptService.queryByID(deptId);
        if (BlankUtil.isNotBlank(dept) && 100L == deptId)
        {
    ...
    public AjaxResult editSave(@Validated SysDept dept)
    {
        ...
        return toAjax(deptService.updateByIDNotNull(dept));
    }
    ...
    public AjaxResult remove(@PathVariable("deptId") Long deptId)
    {
        ...
        if (deptService.queryCount(sysDept) > 0)
        {
    ...
    {
        mmap.put("dept", deptService.queryByID(deptId));
        return prefix + "/tree";
    }
