package com.alina.bootrpc.system.framework.manager.factory;


import com.alina.bootrpc.common.core.constant.Constants;
import com.alina.bootrpc.common.core.utils.AddressUtils;
...
import com.alina.bootrpc.system.framework.util.LogUtils;
...
/**
 * @author     ：迪艾多
 * @date       ：Created on 2019/9/20 14:17
    ...
    public static TimerTask syncSessionToDb(final OnlineSession session)
    {
        return new TimerTask()
        {
            ...
            public void run()
            {
                ...
                SpringUtils.getBean(ISysUserOnlineService.class).commonSave(online);
    ...
    public static TimerTask recordOper(final SysOperLog operLog)
    {
        return new TimerTask()
        {
            ...
            public void run()
            {
                ...
                SpringUtils.getBean(ISysOperLogService.class).commonSave(operLog);
            }
        };
    }
    ...
    public static TimerTask recordLogininfor(final String username, final String status, final String message, final Object... args)
    {
        ...
        return new TimerTask()
        {
            ...
            public void run()
            {
                ...
                // 插入数据
                SpringUtils.getBean(ISysLogininforService.class).commonSave(logininfor);
            }
        };
    }
}
