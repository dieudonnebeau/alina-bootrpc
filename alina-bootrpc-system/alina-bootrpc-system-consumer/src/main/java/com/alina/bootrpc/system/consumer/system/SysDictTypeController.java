...
/**
 * @author     ：迪艾多
 * @date       ：Created on 2019/10/23 14:04
 * @description：数据字典信息
 * @modified By：
 * @version:     1.0
 */
...
public class SysDictTypeController extends BaseController
{
    ...
    public AjaxResult editSave(@Validated SysDictType dict)
    {
        ...
        return toAjax(dictTypeService.updateByIDNotNull(dict));
    }
    ...
    {
        mmap.put("dict", dictTypeService.queryByID(id));
        mmap.put("dictList", dictTypeService.queryAll());
            ...
            ModelMap mmap)
    {
        ...
        mmap.put("dict", dictTypeService.queryOneByParams(SysDictType.class, param));
        return prefix + "/tree";
    }
