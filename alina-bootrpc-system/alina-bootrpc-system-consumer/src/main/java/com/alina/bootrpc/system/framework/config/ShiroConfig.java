...
import com.alina.bootrpc.system.framework.shiro.web.filter.LogoutFilter;
import com.alina.bootrpc.system.framework.shiro.web.filter.captcha.CaptchaValidateFilter;
import com.alina.bootrpc.system.framework.shiro.web.filter.kickout.KickoutSessionFilter;
import com.alina.bootrpc.system.framework.shiro.web.filter.online.OnlineSessionFilter;
...
/**
 * @author     ：迪艾多
 * @date       ：Created on 2019/9/20 13:56
 * @description：权限配置加载
 * @modified By：
 * @version:     1.0
 */
...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/ams.png**", "anon");
